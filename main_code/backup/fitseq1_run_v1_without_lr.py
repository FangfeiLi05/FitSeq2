...
import pandas as pd
import argparse
import fitseq1_methods_v1_without_lr

# try running with command
# python3 ./fitseq1_run_v1_without_lr.py -i ./simu_0_EvoSimulation_Read_Number.csv -t ./fitmut_input_time_points.csv -o test
...
my_obj = fitseq1_methods_v1_without_lr.FitSeq(read_num_seq = read_num_seq,
                                   t_seq = t_seq,
